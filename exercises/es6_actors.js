...
const membersInAtLeast3Films = academyMembers.filter((m) => m.films.length >= 3);
...
// that starts with "A"
const membersInStartsWithAFilms = academyMembers.filter((m) => m.films.find((f) => f.startsWith("A")));
